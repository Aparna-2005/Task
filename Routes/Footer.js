  ...
  return (
    <div className='Footer-container'>
      <div class="row">
        <div class="col-xl-3 col-3">
          ...
          <div className='d-flex flex-column mt-3'>
            <div className='d-flex flex-row p-2'>
              ...
              <p className='ms-2 footer-p'>abcprd@gmail.com</p>
            </div>
            <div className='d-flex flex-row p-2'>
        ...
        <div class="col-xl-3 col-3">
          <h1 className='footer-h1'>Online</h1>
          <p className='footer-p'>Fruits</p>
          <p className='footer-p'>Home products</p>
          <p className='footer-p'>Things</p>
        ...
        <div class="row text-center">
          ...
          <p style={{ color: "#bfbfbf" }} className='footer-h1'>Copyright ©2024 All rights reserved | This template is made with 	&#10084; by <span style={{ color: "green" }}>ABCProduct</span></p>
        </div>
      </div>
    </div>
  )
